...
const TABS: EcosystemTab[] = [
  {
    ...
    highlights: [
      ...
      '40 curated skills: GitHub, Notion, Slack, Spotify, social automation, and more',
  ...
  },
  {
    ...
    highlights: [
      ...
      '@framers/agentos-skills-registry: 80 curated skills + typed catalog with query/filter/lazy-load',
      '23+ tool extensions + 37 channel adapters via @framers/agentos-extensions-registry',

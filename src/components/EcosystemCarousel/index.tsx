...
const TABS: EcosystemTab[] = [
  {
    ...
    highlights: [
      ...
      '37 channels (messaging + social; incl IRC and Zalo Personal), 21 LLM providers',
      '88 curated skills: GitHub, Notion, Slack, Spotify, social automation, and more',
      'Agent immutability with sealed configs',
    ],
    stats: [
      {label: 'Channels', value: '37'},
      {label: 'Providers', value: '21'},
      {label: 'Extensions', value: '115'},
  ...
  },
  {
    ...
    highlights: [
      ...
      '@framers/agentos-skills-registry: 88 curated skills + typed catalog with query/filter/lazy-load',
      '115 curated extensions, including 37 channel adapters, via @framers/agentos-extensions-registry',

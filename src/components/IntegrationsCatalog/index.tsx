...
const TOOLS: CatalogItem[] = [
  ...
  { key: 'skills', displayName: 'Skills Content', description: '69 curated SKILL.md prompt modules for agent capabilities.', category: 'tool', packageName: '@framers/agentos-skills' },
];

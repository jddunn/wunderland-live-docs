...
const TOOLS: CatalogItem[] = [
  ...
  { key: 'skills', displayName: 'Skills Content', description: '88 curated SKILL.md prompt modules for agent capabilities.', category: 'tool', packageName: '@framers/agentos-skills' },
];

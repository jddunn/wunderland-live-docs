...
This installs the skills registry with 88 curated SKILL.md files + typed SDK. See the [Skills System guide](/guides/skills-system) for details.
...
| `@framers/agentos-skills-registry` | Optional | 88 curated SKILL.md files + typed catalog + factories |
